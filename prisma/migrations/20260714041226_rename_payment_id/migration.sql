...
CREATE TABLE "beers" (
    ...
    "stockInLiters" DECIMAL(10,2) NOT NULL,
    "imageUrl" TEXT,
...
-- AddForeignKey
ALTER TABLE "order_items" ADD CONSTRAINT "order_items_beerId_fkey" FOREIGN KEY ("beerId") REFERENCES "beers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
